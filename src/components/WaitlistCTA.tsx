...
const WaitlistCTA = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-r from-primary via-purple-900 to-primary text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center animate-fade-in">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-accent/20 backdrop-blur-sm border border-accent/30 rounded-full px-6 py-3 mb-8">
          ...
          <h2 className="font-playfair text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
            Ready to Find Your
            <br />
            <span className="text-accent drop-shadow-lg">Soulmate?</span>
          </h2>
          ...
          <p className="font-inter text-xl md:text-2xl mb-12 text-white/90 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-accent font-semibold"> affordable and authentic</span> dating platform.
          </p>
          
          <div className="flex flex-col lg:flex-row gap-6 justify-center items-center mb-12">
            <button
              onClick={handleWaitlistClick}
              className="group bg-accent text-dark-gray font-inter font-bold px-12 py-6 rounded-full text-xl hover:bg-accent/90 transition-all duration-300 shadow-2xl hover:shadow-accent/25 transform hover:-translate-y-2 hover:scale-105 inline-flex items-center gap-4"
            >
